...
const SvgBankOutline = ({ title, titleId, ...props }: SVGProps<SVGSVGElement> & SVGRProps) => (
  <svg
  ...
  >
    ...
    <path fill="currentColor" d="M16.331 11.135a1.405 1.405 0 1 0 0-2.81 1.405 1.405 0 0 0 0 2.81Z" />
    <path
      fill="currentColor"
