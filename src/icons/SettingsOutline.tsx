...
const SvgSettingsOutline = ({ title, titleId, ...props }: SVGProps<SVGSVGElement> & SVGRProps) => (
  <svg
  ...
  >
    ...
    <g clipPath="url(#SettingsOutline_svg__a)">
      <mask id="SettingsOutline_svg__b" fill="#fff">
      ...
      <path
        ...
        mask="url(#SettingsOutline_svg__b)"
      />
    </g>
    <defs>
