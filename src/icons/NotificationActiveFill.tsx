...
const SvgNotificationActiveFill = ({ title, titleId, active, ...props }: SVGProps<SVGSVGElement> & SVGRProps) => (
  <svg
  ...
  >
    ...
    />
    <path fill="currentColor" stroke="currentColor" d="m12 8 4-1h1.5l4 2.5 1 3.5.5 6.5 3 5H6.5l1.5-2 1.5-10L12 8Z" />
    <path fill="currentColor" d="M16.038 28a1.971 1.971 0 0 0 1.905-1.684H14.06A1.971 1.971 0 0 0 16.04 28Z" />
    <circle id="activeNotificationFillIcon" cx={23} cy={8} r={4} fill={active ? active : "#BB2525"} />
  </svg>
);
