...
const SvgNotificationActive3D = ({ ...props }: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g filter="url(#NotificationActive3D_svg__f)">
      <path
        fill="url(#NotificationActive3D_svg__g)"
    ...
    <path
      fill="url(#NotificationActive3D_svg__h)"
      d="M9.192 11.431c.63-3.136 3.382-5.4 6.59-5.43h.436c3.208.03 5.96 2.294 6.59 5.43l1.58 7.867a3.37 3.37 0 0 0 .747 1.531l1.052 1.225c.525.612.813 1.39.813 2.193v1.12c0 .35-.285.633-.637.633H5.637A.635.635 0 0 1 5 25.367v-1.12c0-.804.288-1.581.813-2.193l1.052-1.225a3.37 3.37 0 0 0 .747-1.532l1.58-7.866Z"
    />
    <path
      fill="url(#NotificationActive3D_svg__i)"
      d="M9.192 11.431c.63-3.136 3.382-5.4 6.59-5.43h.436c3.208.03 5.96 2.294 6.59 5.43l1.58 7.867a3.37 3.37 0 0 0 .747 1.531l1.052 1.225c.525.612.813 1.39.813 2.193v1.12c0 .35-.285.633-.637.633H5.637A.635.635 0 0 1 5 25.367v-1.12c0-.804.288-1.581.813-2.193l1.052-1.225a3.37 3.37 0 0 0 .747-1.532l1.58-7.866Z"
    />
    ...
    <defs>
      ...
      <linearGradient
        id="NotificationActive3D_svg__g"
        x1={18.094}
        x2={6.618}
        y1={24.45}
        y2={24.45}
      ...
      <linearGradient
        id="NotificationActive3D_svg__h"
        x1={17.785}
        x2={17.785}
        y1={26.218}
        y2={23.686}
      ...
      <linearGradient
        id="NotificationActive3D_svg__k"
        x1={8.268}
        x2={25.464}
        y1={22}
        y2={22}
      ...
      <linearGradient
        id="NotificationActive3D_svg__m"
        x1={23.706}
        x2={16}
        y1={18.5}
        y2={18.5}
      ...
      <radialGradient
        id="NotificationActive3D_svg__a"
        cx={0}
        cy={0}
        r={1}
      ...
      <radialGradient
        id="NotificationActive3D_svg__c"
        cx={0}
        cy={0}
        r={1}
      ...
      <radialGradient
        id="NotificationActive3D_svg__e"
        cx={0}
        cy={0}
        r={1}
      ...
      <radialGradient
        id="NotificationActive3D_svg__i"
        cx={0}
        cy={0}
        r={1}
      ...
      <filter
        id="NotificationActive3D_svg__d"
        width={2.2}
        height={4}
        x={15}
        y={4}
      ...
      <filter
        id="NotificationActive3D_svg__f"
        width={27}
        height={20}
        x={1}
        y={6}
...
export default SvgNotificationActive3D;
