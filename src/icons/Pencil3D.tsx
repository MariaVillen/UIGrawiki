...
const SvgPencil3D = ({ ...props }: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    />
    <path
      fill="url(#Pencil3D_svg__k)"
      d="m16.666 8.877 3.19-3.19 6.484 6.485-3.19 3.19-6.484-6.485Z"
    />
    <path
      fill="url(#Pencil3D_svg__l)"
      d="m16.666 8.877 3.19-3.19 6.484 6.485-3.19 3.19-6.484-6.485Z"
    />
    <path
      fill="url(#Pencil3D_svg__m)"
      d="M2.253 30a.2.2 0 0 1-.219-.218l.218-2.3 2.296 2.297L2.253 30Z"
    />
    <defs>
      <linearGradient
        id="Pencil3D_svg__b"
